...
# COMPLETAR - INICIO
multiplicacion_de_numeros = int(numero_binario, base=2) * int(numero_octal, base=8) * int(numero_hexadecimal, base=16)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
resultado_resta = int(numero_01) - int(numero_02, base=16) -  int(numero_03, base=8) - numero_04
